      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm">Connecting schools, parents, and students like never before.</p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm">Email: info@seatapp.com</p>
        ...
        <div className="mt-8 text-center text-sm">
          <p>&copy; 2024 SEAT. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
